...
const Projects = () => {
  return (
    <section id="projects">
      <motion.h2
        className="mb-16 text-center text-3xl lg:text-4xl"
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
        {PROJECTS.map((project) => (
          <motion.div
            key={project.id}
            className="group relative overflow-hidden rounded-3xl h-[358px]"
          ...
          >
            ...
            <motion.div className="absolute inset-0 flex flex-col items-center justify-center text-white opacity-0 backdrop-blur-lg transition-opacity duration-500 group-hover:opacity-100">
              ...
              <p className="mb-12 p-4 text-[12px]">{project.description}</p>
              <a
                href={project.link}
                target="_blank"
